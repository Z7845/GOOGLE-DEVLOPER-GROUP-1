    ...
    <body>
        <div class="box">
            <form name="form" onsubmit="return isvalid()" method="POST">
                ...
                <div class="inputbx">
                    <span></span>
                    <input type="submit" id="btn" value="பதிவு" name="submit"/>
                </div>
        ...
        <script>
            function isvalid(){
                ...
                if(user.length == "" && pass.length == ""){
                    alert("பயனர் பெயர் மற்றும் கடவுச்சொல் புலங்கள் காலியாக உள்ளன!");
                    return false;
                }
                else if(user.length == ""){
                    ...
                    alert("கடவுச்சொல் புலம் காலியாக உள்ளது!");
                    return false;
                }
                return true;
            }
