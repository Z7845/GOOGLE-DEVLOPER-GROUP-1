    ...
    <body>
        <div class="box">
            <form name="form" action="login.php" onsubmit="return isvalid()" method="POST">
                ...
                <div class="inputbx">
                    <span></span>
                    <input type="text" id="user" name="user" placeholder="યુઝરનામ">
                </div>
                
                <div class="inputbx">
                    <span></span>
                    <input type="password" id="pass" name="pass" placeholder="પાસવર્ડ">
                </div>
            ...
            <div class="registerbox">
                    <span></span>
                    <input type="submit" id="reg" name="reg" value="રજીસ્ટર">
                    <h2>નોંધ: જો નોંધણી નથી કરેલ તો પહેલા નોંધણી કરો!!!</h2>
                </div>
        ...
        <script>
            function isvalid(){
                ...
                if(user.length == "" && pass.length == ""){
                    alert("યુઝરનામ અને પાસવર્ડ ફીલ્ડ ખાલી છે!");
                    return false;
                }
                else if(user.length == ""){
                    alert("યુઝરનામ ફીલ્ડ ખાલી છે!");
                    return false;
                }
                else if(pass.length == ""){
                    alert("પાસવર્ડ ફીલ્ડ ખાલી છે!");
                    return false;
                }
                return true;
            }
